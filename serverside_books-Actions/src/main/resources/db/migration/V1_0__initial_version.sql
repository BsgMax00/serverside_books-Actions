...
create table book (id integer not null, author varchar(255) not null, price_in_eur integer check (price_in_eur<=200 AND price_in_eur>=0), title varchar(255) not null, nr_stars varchar(255) not null, primary key (id));
