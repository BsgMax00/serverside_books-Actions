...
insert into BOOK (ID, TITLE, NR_STARS)
values (nextval('BOOK_SEQ'), 'The year of the flood', 3);/*2*/

insert into BOOK (ID, TITLE, NR_STARS)
values (nextval('BOOK_SEQ'), 'MaddAddam', 4);/*3*/

insert into BOOK (ID, TITLE, NR_STARS)
values (nextval('BOOK_SEQ'), '1Q84', 1);/*4*/

insert into BOOK (ID, TITLE, NR_STARS)
values (nextval('BOOK_SEQ'), 'De opwindvogelkronieken', 3);/*5*/

insert into BOOK (ID, TITLE, NR_STARS)
values (nextval('BOOK_SEQ'), 'Design Patterns', 0);/*6*/
